...
public class ReplyPageMaker {
	...
	private void calcData() { // 전체 필드 변수 값들을 계산하는 메서드
		endPage = (int) (Math.ceil(rpCri.getPage_rp() / (double) displayPageNum) * displayPageNum);
	...
	public String makeQuery(int page_rp) {
		UriComponents uriComponents = UriComponentsBuilder.newInstance().queryParam("page_rp", page_rp)
